...
**7/20 — 소속 연구자의 수학 난제 반증 주장**: Anthropic 소속 수학자 Levent Alpöge가 Claude Fable의 도움으로 87년 미해결 야코비안 추측을 반증했다고 발표(동료검토 전, 검증 가능한 반례 공식은 공개). → [[2026-07-20-claude-fable-jacobian-conjecture]]
