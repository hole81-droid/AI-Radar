...
- **Gemini 3.5 Pro**: 2M 토큰 컨텍스트로 예고, I/O 2026에서 제한 프리뷰 공개 후 GA는 2026-07로 연기된 상태. ([techjournal](https://techjournal.org/gemini-3-5-pro-release-date), [DeepMind 모델 페이지](https://deepmind.google/models/gemini/))
...
- **2026-06-18**: Gemini CLI → Antigravity CLI 전환(개인/Pro/Ultra 티어 서비스 중단) — [Google Developers Blog](https://developers.googleblog.com/an-important-update-transitioning-gemini-cli-to-antigravity-cli/)
...
- **2026-06**: Gemini Spark 업데이트 — macOS 앱 베타(Ultra 전용), Canva·Dropbox·Instacart·OpenTable·Zillow Rentals 연동, 커스텀 MCP 지원 — [blog.google](https://blog.google/innovation-and-ai/products/gemini-app/gemini-spark-updates-june-2026/); Gemini 3.5 Live Translate 출시 — [blog.google](https://blog.google/innovation-and-ai/technology/ai/google-ai-updates-june-2026/)
