...
- **2026-09-22 갱신**: **GPT-6 Sol·Luna** 출시 — GPT-6 Astra(09-04) 세대의 이점을 계승한 중급·경량 모델, Anthropic Opus 5.5와 같은 날 발표로 "가격전쟁" 개시(Luna $0.10/$0.50, GPT-5.6 대비 절반 이하). GPT-5.5는 2026-10-14부로 전 플랜 퇴역 예고. → [[2026-09-22-openai-gpt-6-sol-luna-launch]]
