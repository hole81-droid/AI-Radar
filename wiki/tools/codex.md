...
- **2026-09-04** — **GPT-6 Astra** 출시, Codex는 이전 대화 맥락을 요약·압축 없이 그대로 검색 가능해짐 → [[2026-09-04-openai-gpt-6-astra-launch]]
...
- **2026-09-22** — **GPT-6 Sol·Luna** 출시(ChatGPT Work·Codex·API), Anthropic Opus 5.5와 같은 날 발표로 "가격전쟁" 개시. Luna $0.10/$0.50(100만 토큰당)로 GPT-5.6 대비 절반 이하. GPT-5.5는 10-14 퇴역 예고 → [[2026-09-22-openai-gpt-6-sol-luna-launch]]
