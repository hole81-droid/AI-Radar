...
- [[2026-08-24-headlong-persistent-agent-microharness]] — 요청-응답형 루프를 넘어 "요청 없이도
  스스로 사고를 이어가는" 상시 가동형(persistent) 에이전트를 표방한 MIT·Laude Institute의
  오픈소스 하네스(2026-08-24). 자기중단·시간당 비용·프라이버시 실패 사례를 투명하게 공개해
  루프 엔지니어링 다음 단계인 "지속성 설계"의 현실적 리스크를 보여준다.
