...
- [[case-catalog]] — ★전체 케이스 공식 한 줄 카탈로그 (업무 영역별, 121건) — 케이스 질의는 여기부터
...
- 금융: [[openai-thrive-tax-ai-self-improving]] (★실측 97%·50%↑) · [[theaxlabs-claude-financial-advisors-korea-securities]] (국내 증권사 자산관리 어드바이저 도입 90일 플랜)
