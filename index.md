...
### OpenAI
- [[2026-07-09-openai-gpt-5-6-launch]] — (08-07 갱신) GPT-5.6 Luna, Free·Go 기본 모델로 전환 + Think 버튼 확대 예정 (high)
...
### Google / Gemini
- [[2026-08-05-google-deepmind-leadership-shakeup]] — Google DeepMind CEO 교체(Hassabis 회장·수석과학자로), Jeff Dean 등 퇴사·Discovery Loop 창업 (high)
...
- [[2026-07-19-alibaba-qwen-3-8-preview]] — Alibaba Qwen, 2.4T 파라미터 "Qwen 3.8" 프리뷰, "Fable 5 다음으로 강력" 자평 (medium)
...
- [[anthropic]] — 제품 확장·규제 격변·수익화 전환, +Bernanke 영입·연구자 4명 영입·Claude for Teachers·IPO 투자자 미팅·EU 청문회 반발·Alibaba 리스크 (07-07 스냅샷 + 07-09~15 갱신)
- [[openai]] — "모델 회사에서 국가급 인프라 기업으로", +GPT-5.6 GA·Apple 소송·Heidecke 퇴사·Codex Micro 실출시 (07-07 스냅샷 + 07-09~15 갱신)
...
- [[timeline]] — 업계 주요 이벤트 연대기 (06-18 ~ 08-11, 79건)
- [[sources]] — 모니터링 소스 레지스트리
- newsletter/ — 데일리 뉴스레터 (최신: [[2026-08-11]] · 08-09~08-11 공백 소급 스캔 완료(2026-08-11 실행, 하나로 통합) · 08-05~08-07 공백 소급 스캔 완료(2026-08-08 실행, 하나로 통합) · 08-01~08-03 공백 소급 스캔 완료(2026-08-04 실행, [[2026-08-03]] 하나로 통합) · 07-28 공백 소급 스캔 완료(2026-07-29 실행, 날짜별 파일) · 07-23~07-26 공백 소급 스캔 완료(2026-07-27 실행, [[2026-07-26]] 하나로 통합) · 07-09·07-10·07-17·07-19 공백 소급 스캔 완료(2026-07-20 실행) · 07-11~07-15 위키 반영 완료(승인게이트 폐지 후 소급) · 05-01~07-05 백필 완료, 07-06자는 구 편집 기준으로 작성됨)
